...
export default function NavBar() {
  ...
  return (
      ...
      <div className="flex items-center space-x-4 md:flex gap-5">
        <svg 
      ...
      <nav className={`md:flex z-40 gap-6 items-center ${menuOpen ? "block" : "hidden"}`}>          
          <Anchor to='/' className="w-[69px] h-[32px] text-[24px] font-bold leading-[31.92px] font-bold" href="">Home</Anchor>
          <Anchor to='/cities' className="w-[69px] h-[32px] text-[24px] font-bold leading-[31.92px] font-bold" href="">Cities</Anchor>
